...
export function CloudPointConfigurationPage() {
  ...
  const cadPointCloudEntry: LoadedFrameCloud | null = useMemo(() => {
    ...
    return {
      ...
      description: t('fluidDoser.cloudPointConfiguration.cadPointCloud'),
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-lg font-semibold text-slate-900 dark:text-slate-100">
              {t('fluidDoser.cloudPointConfiguration.title')}
            </h1>
            <p className="text-xs text-slate-500 dark:text-slate-500">
              {folderName ?? t('fluidDoser.cloudPointConfiguration.subtitle')}
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            >
              ...
              {t('fluidDoser.cloudPointConfiguration.uploadCad')}
            </button>
            ...
            >
              ...
              {t('fluidDoser.cloudPointConfiguration.uploadFrame')}
            </button>
